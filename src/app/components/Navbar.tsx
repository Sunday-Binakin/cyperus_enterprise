      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link 
              href="/store"
              className="bg-[#8B4513] text-white px-6 py-2 rounded-full hover:bg-[#6F3410] transition-colors duration-300 text-lg font-['var(--font-bebas-neue)'] tracking-wider"
            >
              Shop Now
            </Link>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link 
                href="/store"
                className="block w-full mt-4 bg-[#8B4513] text-center text-white px-6 py-2 rounded-full hover:bg-[#6F3410] transition-colors duration-300 text-lg font-['var(--font-bebas-neue)'] tracking-wider"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Shop Now
              </Link>
