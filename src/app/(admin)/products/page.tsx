...
const products = [
  {
    ...
    category: 'Beverages',
    variants: [
      { size: '350ml', price: 'GH₵ 15.00', stock: 15 },
      { size: '2L', price: 'GH₵ 45.00', stock: 25 }
    ],
    storageType: '❄️ Frozen',
    status: 'active'
  },
  {
    id: 2,
    ...
    category: 'Nuts',
    variants: [
      { size: '1kg', price: 'GH₵ 50.00', stock: 5 },
      { size: '500g', price: 'GH₵ 28.00', stock: 12 }
    ],
    storageType: '🏠 Cool/Dry',
    status: 'active'
  },
